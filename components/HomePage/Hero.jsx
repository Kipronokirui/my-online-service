...
export default function Hero() {
  return (
      <section className={`${styles.hero}`}>
          <div className='grid max-w-screen-xl px-8 pt-16 mx-auto lg:gap-8 xl:gap-0 lg:py-24 lg:grid-cols-12'>
              <div className='pl-16 mr-auto place-self-center lg:col-span-7'> 
